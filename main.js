...
var $author$project$BookDB$apiUrl = 'https://sample-bookdb.herokuapp.com';
...
_Platform_export({'Main':{'init':$author$project$Main$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{"BookDB.Book":{"args":[],"type":"{ id : Basics.Int, title : String.String, subtitle : String.String, authors : List.List String.String, publishers : List.List String.String, year : Basics.Int, pages : String.String, size : String.String, topics : List.List String.String, ndc : String.String, ndc_full : String.String, ndc1 : Basics.Int, notes : List.List String.String, toc : String.String, target : String.String, isbn10 : String.String, isbn13 : String.String, cover : String.String, caseIds : List.List Basics.Int, libcom : String.String, local : Basics.Bool }"},"BookDB.Chapter":{"args":[],"type":"{ id : Basics.Int, tangenId : Basics.Int, number : Basics.Int, title : String.String, ndcs : List.List String.String }"},"BookDB.KyCase":{"args":[],"type":"{ id : Basics.Int, caseident : String.String, url : String.String, school : String.String, subject : String.String, target : String.String, tangen : String.String, date : String.String, purpose : String.String }"},"BookDB.NdcLabel":{"args":[],"type":"{ ndc : String.String, label : String.String }"},"BookDB.Tangen":{"args":[],"type":"{ id : Basics.Int, textBookId : Basics.Int, number : Basics.Int, title : String.String, chapters : List.List BookDB.Chapter }"},"BookDB.TextBook":{"args":[],"type":"{ id : Basics.Int, title : String.String, grade : String.String, school : String.String }"}},"unions":{"Main.Msg":{"args":[],"tags":{"SelectSchool":["School.School"],"GotTextBooks":["Result.Result Http.Error (List.List BookDB.TextBook)"],"GotTextBook":["Result.Result Http.Error BookDB.TextBook"],"SelectTextBook":["BookDB.TextBook"],"GotTangens":["Result.Result Http.Error (List.List BookDB.Tangen)"],"SelectTangen":["BookDB.Tangen"],"SelectChapter":["BookDB.Chapter"],"FetchBooks":[],"GotNdcLabels":["Result.Result Http.Error (List.List BookDB.NdcLabel)"],"GotBooks":["Result.Result Http.Error (List.List BookDB.Book)"],"SelectNdcTab":["String.String"],"SelectedPagination":["Basics.Int"],"ToggleBookModal":["Main.BookModal"],"GotKyCases":["Result.Result Http.Error (List.List BookDB.KyCase)"],"SelectBook":["BookDB.Book"],"ToggleAdvSearchModal":[],"EditAdvSearchQuery":["String.String"],"SelectAdvSearchNdc":["String.String"],"RequestAdvSearch":[],"GotAdvSearchResult":["Result.Result Http.Error (List.List BookDB.Book)"],"GotAdvSearchResultInit":["Maybe.Maybe String.String","Maybe.Maybe String.String","Result.Result Http.Error (List.List BookDB.Book)"],"BookFilterMsg":["BookFilter.Msg"],"RequestTsv":[],"RequestCsv":[],"RequestPrint":[]}},"Main.BookModal":{"args":[],"tags":{"Closed":[],"Opened":["BookDB.Book"]}},"Basics.Bool":{"args":[],"tags":{"True":[],"False":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String.String"],"Timeout":[],"NetworkError":[],"BadStatus":["Basics.Int"],"BadBody":["String.String"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"List.List":{"args":["a"],"tags":{}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"BookFilter.Msg":{"args":[],"tags":{"SetQueryFilterMode":["BookFilter.QueryMode"],"EditQueryFilter":["String.String"],"ToggleQueryFilter":["Basics.Bool"],"SetBookTargetFilter":["String.String"],"SetBookCollFilter":["BookFilter.CollFilter"],"ToggleKyCaseFilter":["Basics.Bool"]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"School.School":{"args":[],"tags":{"Elementary":[],"JuniorHigh":[],"High":[]}},"String.String":{"args":[],"tags":{"String":[]}},"BookFilter.CollFilter":{"args":[],"tags":{"Both":[],"Own":[],"ILL":[]}},"BookFilter.QueryMode":{"args":[],"tags":{"And":[],"Or":[]}}}}})}});}(this));